...
def import_process_german(inputDir=DATASET_DIR):
    ...
    gender_map={"'male single'": "male",  "'female div/dep/mar'": "female", "'male mar/wid'":"male", "'male div/sep'": "male"}
    status_map={"'male single'": "single",  "'female div/dep/mar'": "married/wid/sep", "'male mar/wid'":"married/wid/sep", "'male div/sep'": "married/wid/sep"}
...
def train_predict(dfI, type_cl="RF", labelEncoding=True, validation="train", k_cv=10, args={}, retClf=False, fold="stratified"):
    ...
    if validation!="cv":
        ...
        y_predict_prob = cross_val_predict(clf, X, y["class"], cv=cv, method='predict_proba')
